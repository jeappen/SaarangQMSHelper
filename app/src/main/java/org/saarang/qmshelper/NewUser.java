...
import org.saarang.qmshelper.Register_old.SubmitRegistration;
...
String gender, dobS,email,accomodation, fname ,lname ,croll,mobnum,cbranch,cname,city,password,tx,age;
...
regbut.setOnClickListener(new View.OnClickListener() {
	...
	class UpdateDetails extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			if(!bcode.isEmpty())
				paramse.add(new BasicNameValuePair("desk_id", bcode));
			if(!password.isEmpty())
            ...
            if(!age.isEmpty()){
                paramse.add(new BasicNameValuePair("age", age));
            }
			/*if(age!=0){
	...
	class SubmitRegistration extends AsyncTask<String, String, String> {
		...
		JSONParser jsonParser = new JSONParser();
		int error;
		String errmsg,user_id,saarang_id;
		@Override
		protected void onPreExecute() {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                try {
                    ...
                    errmsg = json.getString("non_field_errors");
                    error = 1;
                }
            } catch (Exception e) {
                e.printStackTrace();
