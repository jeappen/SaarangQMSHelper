...
String gender, dobS,email,accomodation, fname ,lname ,croll,mobnum,cbranch,cname,city,password,userid,token,bcode,age;
		...
		protected void onPostExecute(String file_url) {
			...
			if(!cbranch.equals("null")){
                ...
                if(spinnerPosition==-1)
                    spinnerPosition = branch_data.getPosition("Others");
			...
			if(bcode!=null && !bcode.equals("-1") && !bcode.equals("null"))
