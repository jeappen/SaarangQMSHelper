package org.saarang.qmshelper.reused;
...
import org.saarang.qmshelper.JSONParser;
import org.saarang.qmshelper.NewUser;
import org.saarang.qmshelper.R;
import org.saarang.qmshelper.Singleton;
			...
			final List<NameValuePair> paramse = new ArrayList<NameValuePair>();
					...
					{	String team="-1";
                        ...
                        //if(!event.getString("name").equals("Startup Hive"))
                            add=separator+event.getString("name")+" -"+event.getString("category")+separator+event.getString("id")+separator+team;
